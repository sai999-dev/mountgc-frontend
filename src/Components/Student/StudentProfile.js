...
const StudentProfile = ({ isEmbedded = false }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (response.data.success) {
        // Update localStorage
        const updatedUser = { ...studentUser, username: formData.username };
          ...
          <div className="bg-gradient-to-r from-green-600 to-green-700 px-6 py-8">
            <div className="flex items-center space-x-4">
              ...
              <div className="text-white">
                <h2 className="text-2xl font-bold">{studentUser?.username}</h2>
                <p className="text-green-100 text-sm">Student Account</p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
                  ...
                  <span className="text-gray-800">{studentUser?.email}</span>
                  {studentUser?.email_verify && (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                    ...
                    <p className="text-green-700 font-medium">
                      {studentUser?.is_active ? "Active" : "Inactive"}
                    </p>
                  </div>
                  ...
                  >
                    ...
                    >
                      {studentUser?.email_verify ? "Verified" : "Not Verified"}
                    </p>
                  </div>
                  ...
                  <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                    ...
                    <p className="text-blue-700 font-medium">
                      {studentUser?.created_at
                        ? new Date(studentUser.created_at).toLocaleDateString(
                            "en-US",
                            {
                              year: "numeric",
                              month: "long",
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-800">
                Keep your account secure by using a strong password and never
                sharing your login credentials with anyone. If you notice any
                suspicious activity, contact our support team immediately.
              </p>
            </div>
          </div>
        </div>
